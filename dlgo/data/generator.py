## This file is designed to work as a 'generator'
# a generator is a function used to load just the data
# needed in the next mini batch. The idea being that you
# could load all 170mb into memory, however, it would be
# much easier to load in the sections that you need one
# at a time using only a fraction of the memory.
