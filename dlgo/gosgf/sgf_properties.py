...
import dlgo.gosgf.sgf_grammar
# from six.moves import range 
"""
line above is currently commented out:
    'In the same page, it tells us that six.moves.range()
     calls xrange() for Python 2 and range() for Python 3.'
Using python3 this shouldn't be needed.
"""
