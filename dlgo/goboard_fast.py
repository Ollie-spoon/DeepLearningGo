## this file is the fastest version of the go game framework
# it includes the classes for GoString, Board, Move, and GameState

# This version was completely copied and pasted and the
# compute_game_result and MoveAge functionalities were commented out
# as they have not been implemented as of yet.

# Modifications from goboard include
# The creation of neighbour and corner tables
# The modification of the __deepcopy__ for Board and GoString
# These changes vastly speed up processing
...
## The neighbour and corner tables calculate all of the possible
# neighbours and corners in advance as they will all be calculated
# at least once. This will dramatically speed up the game
neighbor_tables = {}
corner_tables = {}
...
class GoString():
    ...
    This is largely the same as in goboard, however, deepcopy has
    been redefined to save time and memory.
    """
...
class Board():
    """The Board stores a number of functions used to modify the BoardState
    and to ensure the rules are followed.

    This is complete with zobrist hashing and a reference to the neighbour
    and corner tables.

    __deepcopy__ has been modified to save memory and time
    """
...
class Move():
    ...
    modified __hash__, __str__, and __eq__ for some reason.
    """
...
class GameState():
    """" This is the representation of the state of the game at a given point
    in time.

    Largely the same as the goboard version with zobrist hashing
    """
    ...
    def legal_moves(self, is_pass=True, is_resign=True):
        moves = []
